...
aliases: ["뚜벅쵸", "oddish"]
summary: "#043 뚜벅쵸 (풀 / 독) — GO 최대 CP: 1,228"
...
## Definition / 정의
**뚜벅쵸** (#043)는 일반 포켓몬로, [[type-grass|풀]], [[type-poison|독]] 타입입니다.
...
- [[type-grass|풀 타입]] — 뚜벅쵸의 타입
- [[type-poison|독 타입]] — 뚜벅쵸의 타입
...
| 폼 | 공격 | 방어 | 체력 | 최대 CP(40) |
|-----|------|------|------|------------|
| ODDISH_SHADOW | 131 | 112 | 128 | 1,228 |
## References
- Source: PokéAPI v2 pokemon/43
