...
aliases: ["뿔충이", "weedle"]
summary: "#013 뿔충이 (벌레/독 타입) — 기본 스탯 합계 195"
...
## Definition / 정의
**뿔충이** (#013)는 일반 포켓몬로, [[type-bug|벌레]], [[type-poison|독]] 타입입니다.
...
- [[type-bug|벌레 타입]] — 뿔충이의 타입
- [[type-poison|독 타입]] — 뿔충이의 타입
...
| 폼 | 공격 | 방어 | 체력 | 최대 CP(40) |
|-----|------|------|------|------------|
| WEEDLE_SHADOW | 63 | 50 | 120 | 456 |
## References
- Source: PokéAPI v2 pokemon/13
