---
title: "Raid Counters / 클레스퍼트라 레이드 카운터"
type: concept
language: ko
created: 2026-06-05
modified: 2026-06-05
tags: ["raid", "counter", "type-psychic"]
aliases: ["클레스퍼트라 레이드", "클레스퍼트라 카운터", "espathra raid counter"]
summary: "클레스퍼트라 (에스퍼) 레이드 카운터 상위 15위 — PvE DPS 기반"
---
...
## Related Concepts
- [[pokemon-espathra|클레스퍼트라]] — 포켓몬 상세 정보
- [[type-chart]] — 타입 상성표
