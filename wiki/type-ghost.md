...
aliases: ["고스트", "ghost"]
summary: "포켓몬 고스트 타입의 공격/방어 상성 관계"
---

# Ghost 타입 / 고스트 타입

## Definition / 정의
포켓몬의 18개 타입 중 하나인 **고스트 타입**의 공격 및 방어 상성 정보입니다.
...
| 효과 별로 | ×0.5 | [[type-dark|악]] |
| 효과 없음 | ×0 | [[type-normal|노말]] |

## 방어 상성 (이 타입 포켓몬이 받는 데미지)

| 효과 | 배율 | 공격 타입 |
|------|------|----------|
| 약점 (2배 피해) | ×2 | [[type-ghost|고스트]], [[type-dark|악]] |
| 저항 (0.5배 피해) | ×0.5 | [[type-poison|독]], [[type-bug|벌레]] |
| 무효 (0배 피해) | ×0 | [[type-normal|노말]], [[type-fighting|격투]] |
