---
title: "Raid Counters / 대코파스 레이드 카운터"
type: concept
language: ko
created: 2026-06-05
modified: 2026-06-05
tags: ["raid", "counter", "type-rock", "type-steel"]
aliases: ["대코파스 레이드", "대코파스 카운터", "probopass raid counter"]
summary: "대코파스 (바위 / 강철) 레이드 카운터 상위 15위 — PvE DPS 기반"
---

# 대코파스 레이드 카운터

**타입:** 바위 / 강철 | **약점:** 땅 (2.56×), 격투 (2.56×), 물 (1.60×)
...
## Related Concepts
- [[pokemon-probopass|대코파스]] — 포켓몬 상세 정보
- [[type-chart]] — 타입 상성표
