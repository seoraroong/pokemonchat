...
## Definition / 정의
**아쿠스타** (#121)는 일반 포켓몬로, [[type-water|물]], [[type-psychic|에스퍼]] 타입입니다.
...
- [[type-water|물 타입]] — 아쿠스타의 타입
- [[type-psychic|에스퍼 타입]] — 아쿠스타의 타입
...
| 폼 | 공격 | 방어 | 체력 | 최대 CP(40) |
|-----|------|------|------|------------|
| STARMIE_SHADOW | 210 | 184 | 155 | 2,584 |
## References
- Source: PokéAPI v2 pokemon/121
