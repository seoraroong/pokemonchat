...
aliases: ["노말", "normal"]
summary: "포켓몬 노말 타입의 공격/방어 상성 관계"
---

# Normal 타입 / 노말 타입

## Definition / 정의
포켓몬의 18개 타입 중 하나인 **노말 타입**의 공격 및 방어 상성 정보입니다.
...
|------|------|----------|
| 효과 굉장 | ×2 | 없음 |
| 효과 별로 | ×0.5 | [[type-rock|바위]], [[type-steel|강철]] |
...
| 효과 | 배율 | 공격 타입 |
|------|------|----------|
| 약점 (2배 피해) | ×2 | [[type-fighting|격투]] |
| 저항 (0.5배 피해) | ×0.5 | 없음 |
| 무효 (0배 피해) | ×0 | [[type-ghost|고스트]] |
